...
import com.mpdgr.sudokusolver.controller.SudokuOutput;
...
public class OutputMapper {
    ...
    public SudokuOutput solutionToOutput(Solution solution) {
        SudokuOutput outputModel = new SudokuOutput();
        ...
        outputModel.setTotalTime(String.valueOf(solution.getOperationTime()));
        outputModel.setIterNr(String.valueOf(solution.getIterationCount()));
        outputModel.setWinnerMode(solution.getWinnerMode().toString());
        outputModel.setWinnerThreadNr(String.valueOf(solution.getWinnerThreadNr()));
